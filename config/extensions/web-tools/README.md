...
Vendored for [`pi-setup`](../../../README.md) from
[`dmmulroy/.dotfiles` at `f450e808`](https://github.com/dmmulroy/.dotfiles/tree/f450e80819c08bbede9fd71b35d01dacc43499a2/home/.pi/agent/extensions/web-tools).
...
- `config/extensions/web-tools/settings.ts`

## Source of truth

- extension entry: `config/extensions/web-tools/index.ts`
- settings/defaults: `config/extensions/web-tools/settings.ts`
- fetch Pi adapter: `config/extensions/web-tools/webfetch.ts`
- fetch service: `config/extensions/web-tools/fetch-page.ts`
- public web adapter: `config/extensions/web-tools/network.ts`
- search Pi adapter: `config/extensions/web-tools/websearch.ts`
- search service: `config/extensions/web-tools/search-web.ts`
- Exa provider adapter: `config/extensions/web-tools/providers/exa.ts`
- Exa protocol parser: `config/extensions/web-tools/providers/exa-protocol.ts`
- Exa result parser: `config/extensions/web-tools/providers/exa-results.ts`
- tool output projection: `config/extensions/web-tools/tool-output.ts`
